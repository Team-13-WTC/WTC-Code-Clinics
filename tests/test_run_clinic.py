...
class TestRunClinic(unittest.TestCase):
    ...
    def test_step1_test_operation_call_book(self):
        ...
        cancel=False, date=None, delete=False, description=None, id=None, 
        personal=False, retrieve=False, time=None, volunteer=False, 
        help = False, update = False, days = False, hv= False, hb= False, 
        hr= False, hc= False, hd= False, hp= False, hu= False)))


    def test_step1_test_operation_call_cancel(self):
        self.assertEqual(3,run_clinic.only_one_operation(Namespace(book=False, 
        cancel=True, date=None, delete=False, description=None, id=None, 
        personal=False, retrieve=False, time=None, volunteer=False, 
        help = False, update = False, days = False, hv= False, hb= False, 
        hr= False, hc= False, hd= False, hp= False, hu= False)))
    ...
    def test_step1_test_operation_call_delete(self):
        ...
        cancel=False, date=None, delete=True, description=None, id=None, 
        personal=False, retrieve=False, time=None, volunteer=False, 
        help = False, update = False, days = False, hv= False, hb= False, 
        hr= False, hc= False, hd= False, hp= False, hu= False)))
    ...
    def test_step1_test_operation_call_retrieve(self):
        ...
        cancel=False, date=None, delete=False, description=None, id=None, 
        personal=False, retrieve=True, time=None, volunteer=False, help = False, 
        update = False, days = False, hv= False, hb= False, hr= False, 
        hc= False, hd= False, hp= False, hu= False)))


    def test_step1_test_operation_call_volunteer(self):
        self.assertEqual(0,run_clinic.only_one_operation(Namespace(book=False, 
        cancel=False, date=None, delete=False, description=None, id=None, 
        personal=False, retrieve=False, time=None, volunteer=True, help = False, 
        update = False, days = False, hv= False, hb= False, hr= False, 
        hc= False, hd= False, hp= False, hu= False)))
    ...
    def test_step1_test_operation_call_help(self):
        ...
        cancel=False, date=None, delete=False, description=None, id=None, 
        personal=False, retrieve=False, time=None, volunteer=False, help = True, 
        update = False, days = False, hv= False, hb= False, hr= False, 
        hc= False, hd= False, hp= False, hu= False)))
    ...
    def test_step1_test_operation_call_personal(self):
        ...
        cancel=False, date=None, delete=False, description=None, id=None, 
        personal=True, retrieve=False, time=None, volunteer=False, help = False, 
        update = False, days = False, hv= False, hb= False, hr= False, 
        hc= False, hd= False, hp= False, hu= False)))
    ...
    def test_step1_test_operation_call_update(self):
        ...
        cancel=False, date=None, delete=False, description=None, id=None, 
        personal=False, retrieve=False, time=None, volunteer=False, 
        help = False, update = True, days = False, hv= False, hb= False, 
        hr= False, hc= False, hd= False, hp= False, hu= False)))
