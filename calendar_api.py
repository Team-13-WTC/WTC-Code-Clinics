...
# ap.add_argument('function', help = 'what function to call', nargs = '?')

# ap.add_argument('location', nargs = '?')

# ap.add_argument('speciality', nargs = '?')

# ap.add_argument('date', nargs = '?')

# ap.add_argument('time', nargs = '?')
...
def create_slot():
    title = input("Title of slot? ")
    campus = input("Which campus? ")
    speciality = input("What help can you offer? ")
    date = input("Date of meeting? ")
    time = input("Time of meeting? ")
    username = input("What is your username? ")
    create_event(title, campus, speciality, date, time, username)
...
# if function == 'create_slot':
#     create_slot()
# else:
#     print("""This is a set of
# help functions
# yes""")
