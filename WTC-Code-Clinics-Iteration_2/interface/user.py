...
from volunteer_interface import volunteer
from patient_interface import patient
from Api_callings import filter
...
def validate(command, command_list):
    ...
    if user_input.lower() == 'help':
        ...
        command = 'book'
        user_type = patient
        patient.create_booking(command, command_list)
